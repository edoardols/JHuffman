...
public class HuffmanCodeFile {
    ...
    //attributes class HuffmanCodecmdTest
    ...
    */
    ...
    //write frequencyTableAndHuffmanCode
    ...
    public static void statisticsE(int[] frequency){
    ...
    /* reads file encodedString, write the decoded input and execution characteristics in cmd */
    ...
    public static void decode(){
        ...
        //creation file statisticsDecode.txt
    ...
    public static void decodeData(String data, String[] huffmanCode){
        ...
        System.out.println("\r\n" + "Decoded message");
        String codeRead = "";
        //read character o or 1
        for(char character : encodedString.toCharArray()) {
            //concatenate code
            codeRead = codeRead + character;
            for(int i = 0; i < alphabet_size; i++){
    ...
    public static void main(String[] args){
        // ADDED 10/07/2026 REFACTOR FOR GITHUB
        try {
            // duplicate the System.out (in order to avoid changing the original code)
            PrintStream consoleOut = System.out;

            FileOutputStream fileOut = new FileOutputStream(new File("src/output.txt"), false);

            // Duplicate System.out data
            OutputStream dualOutputStream = new OutputStream() {
                @Override
                public void write(int b) throws java.io.IOException {
                    consoleOut.write(b); // Scrive in console
                    fileOut.write(b);    // Scrive nel file
                }
            ...
            System.setOut(new PrintStream(dualOutputStream, true));
        ...
        try {
            // ADDED 10/07/2026 REFACTOR FOR GITHUB
            String fileName = "data/500k.txt";
            //inputcmd = new String(Files.readAllBytes(Paths.get("src/input.txt")));
            inputcmd = new String(Files.readAllBytes(Paths.get(fileName)));
